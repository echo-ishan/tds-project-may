# Doubts in Q7, Q8
**Topic URL:** [Link](https://discourse.onlinedegree.iitm.ac.in/t/doubts-in-q7-q8/166357)  
...
**Post URL:** [Link](https://discourse.onlinedegree.iitm.ac.in/t/doubts-in-q7-q8/166357/1)  
**Role:**  ds-students
...
> **Image:** The screenshot shows a JSON response from a server running at `127.0.0.1:8000`. The request URL is `/execute?query=what%20is%20the%20status%20of%20ticket`.  The "detail" array contains an error indicating a "missing" "type" at "loc": ["query", "q"], with the message "Field required". The "input" is null, meaning the query parameter "q" was expected but not provided or processed correctly. The "pretty print" checkbox is checked in the UI, indicating the JSON is formatted for readability.
