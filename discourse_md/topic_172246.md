...
### Post #1 by **Akshit Mittal** (ds-students)
...
### Post #3 by **DIGVIJAYSINH SANDEEPSINH CHUDASAMA** (ds-students)
...
### Post #4 by **Sagandeep Kaur** (ds-students)
...
### Post #5 by **Harsh jayswal** (ds-students)
...
### Post #6 by **Harsh jayswal** (ds-students)
...
### Post #7 by **ABHIJEET KUMAR ** (ds-students)
...
### Post #8 by **Vikram Suriyanarayanan** (ds-students)
...
### Post #11 by **Dhruv banerjee** (ds-students)
*April 09, 2025, 13:26 UTC*
...
### Post #12 by **Akash Kumar** (ds-students)
...
### Post #13 by **ABHIJEET KUMAR ** (ds-students)
...
### Post #16 by **Palaash U.** (ds-students)
...
### Post #17 by **Vedant Bhanushali** (ds-students)
...
### Post #18 by **Sonal Raikar** (ds-students)
...
### Post #19 by **Mayank Singh** (ds-students)
...
### Post #21 by **D HARICHARAN ** (ds-students)
*April 09, 2025, 14:28 UTC*
[@carlton](https://discourse.onlinedegree.iitm.ac.in/u/carlton) [@Jivraj](https://discourse.onlinedegree.iitm.ac.in/u/jivraj) [@Saransh\_Saini](https://discourse.onlinedegree.iitm.ac.in/u/saransh_saini) [@s.anand](https://discourse.onlinedegree.iitm.ac.in/u/s.anand)  
...
### Post #22 by **Naman Gupta** (ds-students)
...
### Post #23 by **Jayakrishnan** (Leader, course_support)
...
### Post #24 by **Veer Shah** (ds-students)
...
### Post #25 by **Jayakrishnan** (Leader, course_support)
...
### Post #27 by **Akshit Mittal** (ds-students)
...
### Post #28 by **Jayakrishnan** (Leader, course_support)
...
### Post #29 by **Akshit Mittal** (ds-students)
...
### Post #30 by **Pranaav** (ds-students)
...
### Post #31 by **Muhammed Adhil Pt** (ds-students)
...
### Post #32 by **Akash Kumar** (ds-students)
...
### Post #33 by **Shiva Ramakrishna** (ds-students)
...
### Post #34 by **Jayakrishnan** (Leader, course_support)
...
### Post #35 by **LAKSHAY** (ds-students)
*April 11, 2025, 09:15 UTC*
Thank you for sharing the data [@jkmadathil](https://discourse.onlinedegree.iitm.ac.in/u/jkmadathil) Sir
...
### Post #37 by **Akash Kumar** (ds-students)
...
### Post #38 by **Mishkat Chougule** (ds-students)
...
### Post #39 by **Naman S. ** (ds-students)
...
### Post #40 by **Sagandeep Kaur** (ds-students)
...
### Post #41 by **Karthik V** (ds-students)
...
### Post #42 by **B R GIRI SUBRAHMANYA** (ds-students)
...
### Post #43 by **Naman Gupta** (ds-students)
*April 11, 2025, 13:44 UTC*
...
### Post #44 by **Akshit Mittal** (ds-students)
...
### Post #45 by **Pranaav** (ds-students)
...
### Post #46 by **Karthik V** (ds-students)
...
### Post #47 by **Akshit Mittal** (ds-students)
...
### Post #49 by **Mishkat Chougule** (ds-students)
...
> **Image Content:** *This image displays a **bar chart** titled "**Student Bonus**," visualizing the distribution of bonus amounts received by students. It appears to be a common data visualization used in a data science context to show frequency or counts of a categorical or discrete variable.
...
**Axes Information:**
*   **Horizontal (X) Axis Label:** `Bonus`
    *   This axis represents the specific bonus amount or level awarded. The values shown are discrete integers: 0, 1, 2, 3, 4, 5.
*   **Vertical (Y) Axis Label:** `Students`
    *   This axis represents the count or number of students. The scale ranges from 0 to 50, with major gridlines at intervals of 10.

**Data Presented (Exact Transcriptions of Values):**
Each bar explicitly displays the number of students receiving that specific bonus amount:

*   For `Bonus = 0`: **23** Students
*   For `Bonus = 1`: **36** Students
*   For `Bonus = 2`: **50** Students
*   For `Bonus = 3`: **2** Students
*   For `Bonus = 4`: **0** Students
*   For `Bonus = 5`: **0** Students

**Key Observations/Insights:**
*   The most frequent bonus amount is **2**, with **50** students receiving it, making it the peak of the distribution.
*   A significant number of students also received a bonus of **1** (36 students) or **0** (23 students).
*   The number of students drops sharply for bonus amounts greater than 2.
*   Very few students received a bonus of **3** (only 2 students).
*   No students received a bonus of **4** or **5**.
*   The distribution is clearly skewed, with the majority of students clustered around bonus values of 0, 1, and 2, and a rapid decline thereafter.
...
### Post #53 by **Shambhavi ** (ds-students)
...
### Post #55 by **Andrew David** (ds-students)
...
### Post #56 by **Aindree Chatterjee** (ds-students)
